...
- Removed the Perplexity provider plugin (depended on the Perplexity macOS app cache; no Linux equivalent).

---

Earlier entries below are inherited from upstream openusage and reflect macOS-app history.
